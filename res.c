...
#include<stdlib.h>
#include<string.h>
int cmpp=1;char str2[]="dilmaangemore";int it;
  ...
  do
    {
      ...
      printf("\n\n\n\t Main Menu");
      printf("\n\n\t01. result ");
      printf("\n\n\t02. ENTRY/EDIT MENU (teacher access)\n\n\n################################### enter passcode to continue  *************************************");
      char str;
      ...
      switch(ch)
      {
         case '1': 
          ...
          case '2': 
              ...
              printf("\n\n\n #######################################       wrong password   ****************************************");
              if(cc=='2'){
             printf("for changing password press 1\n");
            char cc;
            cc=getche();
             if(cc=='1')
             {
